...
4. Pada kondisi apa program masuk ke blok else?
...
6. Apa fungsi dari perintah delay(timeDelay)?
...
8. Jika program yang dibuat memiliki alur mati → lambat → cepat → reset (mati), ubah menjadi LED tidak langsung reset → tetapi berubah dari cepat → sedang → mati dan berikan penjelasan disetiap baris kode nya dalam bentuk README.md!
...
5. Jelaskan bagaimana program membuat LED kembali dari kanan ke kiri!
...
7. Buatkan program agar LED menyala tiga LED kanan dan tiga LED kiri secara bergantian dan berikan penjelasan disetiap baris kode nya dalam bentuk README.md!
